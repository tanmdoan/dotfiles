---
name: update-pr-desc
description: "Updates a GitHub PR description from Linear context and the branch diff. Use when asked to run /update-pr-desc or refresh a PR body from a Linear issue."
